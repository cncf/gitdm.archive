...
All scripts are configured to ignore commits related to files from `contrib` directory. This is because external sources are placed here, and may commit are just adding external libraries which would make data less acurate
