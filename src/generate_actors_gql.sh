#!/bin/sh
PG_HOST="`cat ~/dev/go/src/github.com/cncf/devstats-helm-graphql/devstats-helm-graphql/secrets/PG_HOST.secret`" PG_PASS="`cat ~/dev/go/src/github.com/cncf/devstats-helm-graphql/devstats-helm-graphql/secrets/PG_PASS.secret`" ~/dev/go/src/github.com/cncf/devstats/devel/k8s_generate_actors_gql.sh > ~/dev/alt/gitdm/src/actors_gql.txt
