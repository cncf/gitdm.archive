...
ruby delete_json_fields.rb "$1" 'avatar_url,gravatar_id,url,html_url,followers_url,following_url,gists_url,starred_url,subscriptions_url,organizations_url,repos_url,events_url,received_events_url,emails,twitter_username,sex,sex_prob,age,tz,type,site_admin,hireable,created_at,update_at'
