...
CSV.open('fullconact_developer_self_historical_organizations.csv', 'w') do |csv|
...
puts 'exported developer organizations to fullconact_developer_independent_historical_organizations.csv'
